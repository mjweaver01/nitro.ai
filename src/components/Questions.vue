  ...
  data() {
    return {
      defaultQuestions: [
        ...
        'Suggest some books that will help me learn more about powerlifting',
        'Suggest an outfit for a WSBB powerlifter',
        ...
        'What is the Conjugate Method? How can I get started with it?',
